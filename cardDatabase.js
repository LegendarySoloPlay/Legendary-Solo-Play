...
const villains = [
    {
        ...
        name: "Brotherhood",
        cards: [
            { id: 1, villainGroupName: "Brotherhood", villainId: 1, team: "Brotherhood", name: "Blob", type: "Villain", attack: 4, originalAttack: 4, victoryPoints: 2, ambushEffect: "None", fightEffect: "None", escapeEffect: "None", fightCondition: "heroYouHave", conditionType: "team", condition: "X-Men", alwaysLeads: "true", image: "Visual Assets/Villains/Brotherhood_Blob.webp" },
            { id: 2, villainGroupName: "Brotherhood", villainId: 1, team: "Brotherhood", name: "Juggernaut", type: "Villain", attack: 6, originalAttack: 6, victoryPoints: 4, ambushEffect: "chooseHeroesToKOFromDiscardPile", fightEffect: "None", escapeEffect: "EscapeChooseHandHeroesToKO", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/Brotherhood_Juggernaut.webp" },
            { id: 3, villainGroupName: "Brotherhood", villainId: 1, team: "Brotherhood", name: "Mystique", type: "Villain", attack: 5, originalAttack: 5, victoryPoints: 3, ambushEffect: "None", fightEffect: "None", escapeEffect: "handleMystiqueEscape", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/Brotherhood_Mystique.webp" },
            { id: 4, villainGroupName: "Brotherhood", villainId: 1, team: "Brotherhood", name: "Sabretooth", type: "Villain", attack: 5, originalAttack: 5, victoryPoints: 3, ambushEffect: "None", fightEffect: "FightRevealXMenOrWound", escapeEffect: "EscapeRevealXMenOrWound", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/Brotherhood_Sabretooth.webp" }
        ]
    },
    {
        id: 2,
        ...
        cards: [
            { id: 5, villainGroupName: "Enemies of Asgard", villainId: 2, team: "Enemies of Asgard", name: "Frost Giant", type: "Villain", quantity: 3, attack: 4, originalAttack: 4, victoryPoints: 2, ambushEffect: "None", fightEffect: "FightRevealRangeOrWound", escapeEffect: "EscapeRevealRangeOrWound", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/EnemiesOfAsgard_FrostGiant.webp" },
            { id: 6, villainGroupName: "Enemies of Asgard", villainId: 2, team: "Enemies of Asgard", name: "Destroyer", type: "Villain", quantity: 1, attack: 7, originalAttack: 7, victoryPoints: 5, ambushEffect: "None", fightEffect: "KOAllSHIELD", escapeEffect: "EscapeChooseHeroesToKO", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/EnemiesOfAsgard_Destroyer.webp" },
            { id: 7, villainGroupName: "Enemies of Asgard", villainId: 2, team: "Enemies of Asgard", name: "Enchantress", type: "Villain", quantity: 2, attack: 6, originalAttack: 6, victoryPoints: 4, ambushEffect: "None", fightEffect: "FightDrawThree", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/EnemiesOfAsgard_Enchantress.webp" },
            { id: 8, villainGroupName: "Enemies of Asgard", villainId: 2, team: "Enemies of Asgard", name: "Ymir, Frost Giant King", type: "Villain", quantity: 2, attack: 6, originalAttack: 6, victoryPoints: 4, ambushEffect: "AmbushRevealRangeOrWound", fightEffect: "koAnyNumberOfWounds", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/EnemiesOfAsgard_Ymir.webp" }
        ]
    },
    {
        id: 3,
    ...
    },
    {
        ...
        cards: [
            { id: 13, villainGroupName: "Masters of Evil", villainId: 4, team: "Masters of Evil", name: "Ultron", type: "Villain", attack: 6, originalAttack: 6, victoryPoints: 2, ambushEffect: "None", fightEffect: "None", escapeEffect: "EscapeRevealTechOrWound", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/MastersOfEvil_Ultron.webp" },
            { id: 14, villainGroupName: "Masters of Evil", villainId: 4, team: "Masters of Evil", name: "Whirlwind", type: "Villain", attack: 4, originalAttack: 4, victoryPoints: 2, ambushEffect: "None", fightEffect: "rooftopsOrBridgeKOs", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/MastersOfEvil_Whirlwind.webp" },
            { id: 15, villainGroupName: "Masters of Evil", villainId: 4, team: "Masters of Evil", name: "Baron Zemo", type: "Villain", attack: 6, originalAttack: 6, victoryPoints: 4, ambushEffect: "None", fightEffect: "AvengersToBystanders", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/MastersOfEvil_BaronZemo.webp" },
            { id: 16, villainGroupName: "Masters of Evil", villainId: 4, team: "Masters of Evil", name: "Melter", type: "Villain", attack: 5, originalAttack: 5, victoryPoints: 3, ambushEffect: "None", fightEffect: "topCardKOOrPutBack", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/MastersOfEvil_Melter.webp" }
        ]
    },
    {
        id: 5,
        name: "Radiation",
        cards: [
            { id: 17, villainGroupName: "Radiation", villainId: 5, team: "Radiation", name: "Abomination", type: "Villain", attack: 5, originalAttack: 5, victoryPoints: 3, ambushEffect: "None", fightEffect: "streetsOrBridgeBystanders", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/Radiation_Abomination.webp" },
            { id: 18, villainGroupName: "Radiation", villainId: 5, team: "Radiation", name: "The Leader", type: "Villain", attack: 4, originalAttack: 4, victoryPoints: 2, ambushEffect: "extraVillainDraw", fightEffect: "None", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/Radiation_TheLeader.webp" },
            { id: 19, villainGroupName: "Radiation", villainId: 5, team: "Radiation", name: "Maestro", type: "Villain", attack: 6, originalAttack: 6, victoryPoints: 4, ambushEffect: "None", fightEffect: "strengthHeroesNumberToKO", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/Radiation_Maestro.webp" },
            { id: 20, villainGroupName: "Radiation", villainId: 5, team: "Radiation", name: "Zzzax", type: "Villain", attack: 5, originalAttack: 5, victoryPoints: 3, ambushEffect: "None", fightEffect: "FightRevealStrengthOrWound", escapeEffect: "EscapeRevealStrengthOrWound", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/Radiation_Zzzax.webp" }
        ]
    },
    {
        id: 6,
        name: "Skrulls",
        cards: [
            { id: 21, villainGroupName: "Skrulls", villainId: 6, team: "Skrulls", name: "Super-Skrull", type: "Villain", quantity: 3, attack: 4, originalAttack: 4, victoryPoints: 2, ambushEffect: "None", fightEffect: "FightKOHeroYouHave", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/Skrulls_SuperSkrull.webp" },
            { id: 22, villainGroupName: "Skrulls", villainId: 6, team: "Skrulls", name: "Skrull Shapeshifters", type: "Villain", quantity: 3, attack: 0, originalAttack: 0, victoryPoints: 2, ambushEffect: "AmbushRightHeroSkrull", fightEffect: "fightSkrullShapeshifters", escapeEffect: "escapeSkrullShapeshifter", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/Skrulls_SkrullShapeshifters.webp" },
            { id: 23, villainGroupName: "Skrulls", villainId: 6, team: "Skrulls", name: "Skrull Queen Veranke", type: "Villain", quantity: 1, attack: 0, originalAttack: 0, victoryPoints: 4, ambushEffect: "highestCostHeroSkrullQueen", fightEffect: "fightSkrullQueen", escapeEffect: "escapeSkrullQueen", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/Skrulls_SkrullQueen.webp" },
            { id: 24, villainGroupName: "Skrulls", villainId: 6, team: "Skrulls", name: "Paibok the Power Skrull", type: "Villain", quantity: 1, attack: 8, originalAttack: 8, victoryPoints: 3, ambushEffect: "None", fightEffect: "freeHeroGain", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/Skrulls_Paibok.webp" }
        ]
    },
    {
        id: 7,
        name: "Spider-Foes",
        cards: [
            { id: 25, villainGroupName: "Spider-Foes", villainId: 7, team: "Spider-Foes", name: "Venom", type: "Villain", attack: 5, originalAttack: 5, victoryPoints: 3, ambushEffect: "None", fightEffect: "None", escapeEffect: "EscapeDrawWound", fightCondition: "heroYouHave", conditionType: "class1", condition: "Covert", alwaysLeads: "true", image: "Visual Assets/Villains/SpiderFoes_Venom.webp" },
            { id: 26, villainGroupName: "Spider-Foes", villainId: 7, team: "Spider-Foes", name: "Green Goblin", type: "Villain", attack: 6, originalAttack: 6, victoryPoints: 4, ambushEffect: "ambushBystander", fightEffect: "None", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/SpiderFoes_GreenGoblin.webp" },
            { id: 27, villainGroupName: "Spider-Foes", villainId: 7, team: "Spider-Foes", name: "The Lizard", type: "Villain", attack: 3, originalAttack: 3, victoryPoints: 2, ambushEffect: "None", fightEffect: "sewersWound", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/SpiderFoes_TheLizard.webp" },
            { id: 28, villainGroupName: "Spider-Foes", villainId: 7, team: "Spider-Foes", name: "Doctor Octopus", type: "Villain", attack: 4, originalAttack: 4, victoryPoints: 2, ambushEffect: "None", fightEffect: "DrOctopusNextDraw2", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/SpiderFoes_DrOctopus.webp" }
        ]
    },
    {
        id: 7,
        ...
        cards: [
            { id: 29, villainGroupName: "Emissaries of Evil", villainId: 8, team: "Emissaries of Evil", name: "Rhino", type: "Villain", attack: 5, originalAttack: 5, victoryPoints: 3, ambushEffect: "rhinoAmbush", fightEffect: "None", escapeEffect: "rhinoEscape", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_EmissariesOfEvil_Rhino.webp" },
            { id: 30, villainGroupName: "Emissaries of Evil", villainId: 8, team: "Emissaries of Evil", name: "Electro", type: "Villain", attack: 6, originalAttack: 6, victoryPoints: 4, ambushEffect: "electroAmbush", fightEffect: "None", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_EmissariesOfEvil_Electro.webp" },
            { id: 31, villainGroupName: "Emissaries of Evil", villainId: 8, team: "Emissaries of Evil", name: "Egghead", type: "Villain", attack: 4, originalAttack: 4, victoryPoints: 2, ambushEffect: "eggheadAmbush", fightEffect: "None", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_EmissariesOfEvil_Egghead.webp" },
            { id: 32, villainGroupName: "Emissaries of Evil", villainId: 8, team: "Emissaries of Evil", name: "Gladiator", type: "Villain", attack: 5, originalAttack: 5, victoryPoints: 3, ambushEffect: "gladiatorAmbush", fightEffect: "None", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_EmissariesOfEvil_Gladiator.webp" }
        ]
    },
    {
        id: 7,
        name: "Four Horsemen",
        cards: [
            { id: 33, villainGroupName: "Four Horsemen", villainId: 9, team: "Four Horsemen", name: "War", type: "Villain", attack: 6, originalAttack: 6, victoryPoints: 4, ambushEffect: "None", fightEffect: "warFight", escapeEffect: "warEscape", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_FourHorsemen_War.webp" },
            { id: 34, villainGroupName: "Four Horsemen", villainId: 9, team: "Four Horsemen", name: "Famine", type: "Villain", attack: 4, originalAttack: 4, victoryPoints: 2, ambushEffect: "None", fightEffect: "famineFight", escapeEffect: "famineEscape", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_FourHorsemen_Famine.webp" },
            { id: 35, villainGroupName: "Four Horsemen", villainId: 9, team: "Four Horsemen", name: "Pestilence", type: "Villain", attack: 5, originalAttack: 5, victoryPoints: 3, ambushEffect: "None", fightEffect: "pestilenceFight", escapeEffect: "pestilenceEscape", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_FourHorsemen_Pestilence.webp" },
            { id: 36, villainGroupName: "Four Horsemen", villainId: 9, team: "Four Horsemen", name: "Death", type: "Villain", attack: 7, originalAttack: 7, victoryPoints: 5, ambushEffect: "None", fightEffect: "deathFight", escapeEffect: "deathEscape", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_FourHorsemen_Death.webp" }
        ]
    },
    {
        id: 7,
        name: "Marauders",
        cards: [
            { id: 37, villainGroupName: "Marauders", villainId: 10, team: "Marauders", name: "Scalphunter", type: "Villain", attack: 4, originalAttack: 4, bonusBystanderAttack: 1, victoryPoints: 2, ambushEffect: "scalphunterAmbush", fightEffect: "None", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_Marauders_Scalphunter.webp" },
            { id: 38, villainGroupName: "Marauders", villainId: 10, team: "Marauders", name: "Chimera", type: "Villain", attack: 3, originalAttack: 3, bonusBystanderAttack: 3, victoryPoints: 3, ambushEffect: "chimeraAmbush", fightEffect: "None", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_Marauders_Chimera.webp" },
            { id: 39, villainGroupName: "Marauders", villainId: 10, team: "Marauders", name: "Blockbuster", type: "Villain", attack: 4, originalAttack: 4, bonusBystanderAttack: 2, victoryPoints: 2, ambushEffect: "blockbusterAmbush", fightEffect: "None", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_Marauders_Blockbuster.webp" },
            { id: 40, villainGroupName: "Marauders", villainId: 10, team: "Marauders", name: "Vertigo", type: "Villain", attack: 5, originalAttack: 5, victoryPoints: 3, ambushEffect: "None", fightEffect: "vertigoFight", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", errata: "Vertigo - Errata", image: "Visual Assets/Villains/DarkCity_Marauders_Vertigo.webp" }
        ]
    },
    {
        id: 7,
        ...
        cards: [
            { id: 41, villainGroupName: "Mutant Liberation Front", villainId: 11, team: "Mutant Liberation Front", name: "Zero", type: "Villain", attack: 0, originalAttack: 0, victoryPoints: 2, ambushEffect: "None", fightEffect: "zeroFight", escapeEffect: "None", fightCondition: "zeroCostCards", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_MLF_Zero.webp" },
            { id: 42, villainGroupName: "Mutant Liberation Front", villainId: 11, team: "Mutant Liberation Front", name: "Wildside", type: "Villain", attack: 5, originalAttack: 5, victoryPoints: 3, ambushEffect: "None", fightEffect: "wildsideFight", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_MLF_Wildside.webp" },
            { id: 43, villainGroupName: "Mutant Liberation Front", villainId: 11, team: "Mutant Liberation Front", name: "Forearm", type: "Villain", attack: 4, originalAttack: 4, victoryPoints: 4, ambushEffect: "None", fightEffect: "None", escapeEffect: "None", fightCondition: "fourDifferentNames", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_MLF_Forearm.webp" },
            { id: 44, villainGroupName: "Mutant Liberation Front", villainId: 11, team: "Mutant Liberation Front", name: "Reignfire", type: "Villain", attack: 6, originalAttack: 6, victoryPoints: 4, ambushEffect: "None", fightEffect: "None", escapeEffect: "reignfireEscape", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_MLF_Reignfire.webp" }
        ]
    },
    {
        id: 7,
    ...
    },
    {
        ...
        name: "Underworld",
        cards: [
            { id: 49, villainGroupName: "Underworld", villainId: 13, team: "Underworld", name: "Blackheart", type: "Villain", attack: 6, originalAttack: 6, victoryPoints: 4, ambushEffect: "blackheartAmbush", fightEffect: "blackheartFight", escapeEffect: "blackheartEscape", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_Underworld_Blackheart.webp" },
            { id: 50, villainGroupName: "Underworld", villainId: 13, team: "Underworld", name: "Dracula", type: "Villain", attack: 3, originalAttack: 3, victoryPoints: 4, ambushEffect: "draculaAmbush", fightEffect: "draculaFight", escapeEffect: "draculaEscape", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_Underworld_Dracula.webp" },
            { id: 51, villainGroupName: "Underworld", villainId: 13, team: "Underworld", name: "Azazel", type: "Villain", attack: 4, originalAttack: 4, victoryPoints: 2, ambushEffect: "None", fightEffect: "azazelFight", escapeEffect: "None", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_Underworld_Azazel.webp" },
            { id: 52, villainGroupName: "Underworld", villainId: 13, team: "Underworld", name: "Lilith, Daughter of Dracula", type: "Villain", attack: 5, originalAttack: 5, victoryPoints: 3, ambushEffect: "None", fightEffect: "None", escapeEffect: "lilithEscape", fightCondition: "None", conditionType: "None", condition: "None", alwaysLeads: "true", image: "Visual Assets/Villains/DarkCity_Underworld_LilithDaughterOfDracula.webp" }
        ]
    }
];
